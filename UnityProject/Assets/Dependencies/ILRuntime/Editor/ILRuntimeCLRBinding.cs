...
{
    [UnityEditor.MenuItem("JEngine/ILRuntime/Generate CLR Biding by DLL")]
    static void GenerateCLRBindingByAnalysis()
    {
        //用新的分析热更dll调用引用来生成绑定代码
        ILRuntime.Runtime.Enviorment.AppDomain domain = new ILRuntime.Runtime.Enviorment.AppDomain();
        using (System.IO.FileStream fs = new System.IO.FileStream("Assets/HotUpdateResources/Dll/Hidden~/HotUpdateScripts.dll", System.IO.FileMode.Open, System.IO.FileAccess.Read))
        {
