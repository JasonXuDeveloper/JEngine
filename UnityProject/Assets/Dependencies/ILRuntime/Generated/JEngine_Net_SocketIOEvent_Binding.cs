...
namespace ILRuntime.Runtime.Generated
{
    unsafe class JEngine_Net_SocketIOEvent_Binding
    {
        ...
        static StackObject* get_name_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            JEngine.Net.SocketIOEvent instance_of_this_method = (JEngine.Net.SocketIOEvent)typeof(JEngine.Net.SocketIOEvent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
