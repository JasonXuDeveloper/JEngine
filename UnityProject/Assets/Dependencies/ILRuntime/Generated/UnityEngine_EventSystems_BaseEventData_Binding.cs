...
{
    unsafe class UnityEngine_EventSystems_BaseEventData_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.EventSystems.BaseEventData);
            args = new Type[]{typeof(UnityEngine.GameObject)};
            method = type.GetMethod("set_selectedObject", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_selectedObject_0);
