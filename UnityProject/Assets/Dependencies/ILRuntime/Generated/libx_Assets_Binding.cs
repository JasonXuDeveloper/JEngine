...
namespace ILRuntime.Runtime.Generated
{
    unsafe class libx_Assets_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, UnloadAsset_2);
            args = new Type[]{};
            method = type.GetMethod("RemoveUnusedAssets", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, RemoveUnusedAssets_3);
        ...
        static StackObject* UnloadAsset_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* RemoveUnusedAssets_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
