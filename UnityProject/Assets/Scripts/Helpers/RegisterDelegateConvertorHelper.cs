...
namespace JEngine.Helper
{
    public class RegisterDelegateConvertorHelper
    {
        ...
        public void Register(AppDomain appdomain)
        {
            ...
            appdomain.DelegateManager.RegisterDelegateConvertor<JEngine.Core.BindableProperty<System.Int64>.onChange_withOld>((act) =>
            {
                return new JEngine.Core.BindableProperty<System.Int64>.onChange_withOld((oldVal, newVal) =>
                {
            ...
            appdomain.DelegateManager.RegisterDelegateConvertor<JEngine.Core.BindableProperty<System.Object>.onChange_withOld>((act) =>
            {
                return new JEngine.Core.BindableProperty<System.Object>.onChange_withOld((oldVal, newVal) =>
                {
