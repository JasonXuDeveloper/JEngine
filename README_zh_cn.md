...
- **安全更新** - 热更资源（资产和DLL/PDB）支持XOR/AES/ChaCha20加密
- **商用验证** - 经个人和企业团队生产环境验证
...
| 包名 | 描述 |
|------|------|
| **JEngine.Core** | 支持运行时热更，附带安全且高性能的功能 |

### 可选包

| 包名 | 描述 |
|------|------|
| **JEngine.Util** | 工具类库，包含JAction和JObjectPool |
