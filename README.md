...
1,000+ games shipped · 100+ companies in production · Claude Code AI integration built in.
...
[Get Started](https://jengine.xgamedev.net/) | [Documentation](https://jengine.xgamedev.net/) | [中文文档](https://github.com/JasonXuDeveloper/JEngine/blob/master/README_zh_cn.md)
